					...
					<div id="page">
						...
						<main>
												...
												<div className="row justify-content-center justify-content-md-start">
													<div className="col-lg-12 static">
														<div className="slide-text text-center black">
															...
															<p className="owl-slide-animated owl-slide-subtitle">
																Lightweight cushioning and
																durable support with a
																Phylon midsole
															</p>
															<div className="owl-slide-animated owl-slide-cta">
																<a
							...
							<div
								...
								style={{
									backgroundImage: 'url(/assets/img/featured_home.jpg)',
								}}>
								<div
									className="opacity-mask d-flex align-items-center"
									data-opacity-mask="rgba(0, 0, 0, 0.5)">
								...
								<div className="row">
									...
									<div className="col-lg-3 col-md-6">
										...
										<div
											...
											<ul>
												<li>
													<i className="ti-home"></i>97845 Baker
													st. 567
													<br />
													Los Angeles - US
												</li>
